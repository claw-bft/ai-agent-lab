...
class AICodeGenerator:
    ...
    FRAMEWORK_TEMPLATES = {
        "fastapi": {
            "dependencies": ["fastapi>=0.104.0", "uvicorn[standard]>=0.24.0", "pydantic>=2.5.0"],
            "structure": ["main.py", "models.py", "routers/", "services/", "config.py"]
        },
        "flask": {
            "dependencies": ["flask>=3.0.0", "flask-sqlalchemy", "flask-migrate"],
            "structure": ["app.py", "models.py", "routes.py", "config.py", "templates/"]
        },
        "django": {
            "dependencies": ["django>=5.0", "djangorestframework"],
