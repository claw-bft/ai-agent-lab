...
cd web-editor
python -m http.server 8080
# 访问 http://localhost:8080/natural-language.html
```
...
**支持的Agent识别：**
- `finance-pro`: 自动识别"股票"、"行情"、"价格"等关键词
- `research-pro`: 自动识别"研究"、"搜索"、"分析"等关键词
- `product-pro`: 自动识别"产品"、"PRD"、"竞品"等关键词
- `coding-pro`: 自动识别"代码"、"开发"、"原型"等关键词
...
### 2026-02-28
- ✅ **实现自然语言工作流编排 (web-editor/natural-language.html)**
- ✅ 支持智能解析自然语言描述
- ✅ 自动识别 Agent 和任务类型
- ✅ 提供6个自然语言示例模板
- ✅ 可视化编辑器增强：撤销/重做、复制粘贴、验证、自动保存
